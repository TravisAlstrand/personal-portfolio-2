...
export default function Header() {
  ...
  return (
    <>
          ...
          <header className="flex items-center justify-between">
            ...
            <>
              ...
              <nav className="hidden lg:block">
                <ul className="text-primary flex gap-12">
                  <li>
      ...
      <div
        className={`fixed top-20 left-1/2 z-20 w-11/12 max-w-sm transition-transform duration-300 ease-in-out lg:hidden ${menuIsOpen ? "-translate-x-1/2" : "translate-x-full"}`}
      >
        <SketchBorderWrapper className="bg-card p-12">
          ...
          >
            <ul className="text-primary flex flex-col items-center justify-center gap-8">
              <li>
                <a
                  href="#about"
